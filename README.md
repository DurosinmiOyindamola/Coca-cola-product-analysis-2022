...
### Analysis Steps
1. Data Collection
_ Obtained the Coca-Cola 2022 dataset containing product-level sales and performance details.
2. Data Cleaning (Power Query)
- Removed duplicates
- Fixed missing values and inconsistent fields
- Standardized date and product category formats
- Ensured revenue calculations were accurate
3. Data Modeling
